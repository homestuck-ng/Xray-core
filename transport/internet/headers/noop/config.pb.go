...
const file_transport_internet_headers_noop_config_proto_rawDesc = "" +
	...
	"(com.xray.transport.internet.headers.noopP\x01Z9github.com/homestuck-ng/xray-core/transport/internet/headers/noop\xaa\x02$Xray.Transport.Internet.Headers.Noopb\x06proto3"
